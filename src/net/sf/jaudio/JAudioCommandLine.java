...
import net.sf.jaudio.FeatureExtractor.CommandLineThread;
...
import net.sf.jaudio.FeatureExtractor.DataTypes.RecordingInfo;
...
public class JAudioCommandLine {
        ...
        if (args[0].equals("-b")) {
            ...
            if (!batch.exists()) {
                ...
                for (int i = 0; i < o.length; ++i) {
                    ...
                    try {
                        dm.featureKey = new FileOutputStream(new File(
                                b.getDestinationFK()));
                        dm.featureValue = new FileOutputStream(new File(
                                b.getDestinationFV()));
                        b.setDataModel(dm);
    ...
    public static void executeSettings(String[] args) throws Exception {
        ...
        String[] aggNames = ((LinkedList<String>) data[9])
                .toArray(new String[] {});
        String[][] aggFeatures = ((LinkedList<String[]>) data[10])
                .toArray(new String[][] {});
        String[][] aggParameters = ((LinkedList<String[]>) data[11])
                .toArray(new String[][] {});
        ...
        for (int i = 0; i < names.length; i++) {
            ...
            recording_info[i] = new RecordingInfo(names[i].getName(),
                    names[i].getPath(), null, false);
        }// for i in names
