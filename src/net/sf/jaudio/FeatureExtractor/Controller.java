...
import net.sf.jaudio.FeatureExtractor.ACE.DataTypes.Batch;
import net.sf.jaudio.FeatureExtractor.ACE.DataTypes.FeatureDefinition;
import net.sf.jaudio.FeatureExtractor.actions.*;
...
public class Controller implements ModelListener {
	...
	/**
	 * @see net.sf.jaudio.FeatureExtractor.actions.ExitAction
	 */
	public ExitAction exitAction = new ExitAction();

	/**
	 * @see net.sf.jaudio.FeatureExtractor.actions.SaveAction
	 */
	public SaveAction saveAction;

	/**
	 * @see net.sf.jaudio.FeatureExtractor.actions.LoadAction
	 */
	...
	/**
	 * @see net.sf.jaudio.FeatureExtractor.actions.RecordFromMicAction
	 */
	public RecordFromMicAction recordFromMicAction = new RecordFromMicAction(
			this);

	/**
	 * @see net.sf.jaudio.FeatureExtractor.actions.SynthesizeAction
	 */
	public SynthesizeAction synthesizeAction;

	/**
	 * @see net.sf.jaudio.FeatureExtractor.actions.ViewFileInfoAction
	 */
	public ViewFileInfoAction viewFileInfoAction;

	/**
	 * @see net.sf.jaudio.FeatureExtractor.actions.AddRecordingAction
	 */
	public AddRecordingAction addRecordingsAction = new AddRecordingAction();

	/**
	 * @see net.sf.jaudio.FeatureExtractor.actions.RemoveRecordingAction
	 */
	public RemoveRecordingAction removeRecordingsAction = new RemoveRecordingAction();

	/**
	 * @see net.sf.jaudio.FeatureExtractor.actions.GlobalWindowChangeAction
	 */
	public GlobalWindowChangeAction globalWindowChangeAction;

	/**
	 * @see net.sf.jaudio.FeatureExtractor.actions.OutputTypeAction
	 */
	public OutputTypeAction outputTypeAction = new OutputTypeAction();

	/**
	 * @see net.sf.jaudio.FeatureExtractor.actions.PlayNowAction
	 */
	public PlayNowAction playNowAction;

	/**
	 * @see net.sf.jaudio.FeatureExtractor.actions.PlaySamplesAction
	 */
	public PlaySamplesAction playSamplesAction;

	/**
	 * @see net.sf.jaudio.FeatureExtractor.actions.StopPlayBackAction
	 */
	public StopPlayBackAction stopPlayBackAction;

	/**
	 * @see net.sf.jaudio.FeatureExtractor.actions.PlayMIDIAction
	 */
	public PlayMIDIAction playMIDIAction = new PlayMIDIAction();

	/**
	 * @see net.sf.jaudio.FeatureExtractor.actions.SamplingRateAction
	 */
	public SamplingRateAction samplingRateAction = new SamplingRateAction();

	/**
	 * @see net.sf.jaudio.FeatureExtractor.actions.EditRecordingsAction
	 */
	public EditRecordingsAction editRecordingsAction;

	/**
	 * @see net.sf.jaudio.FeatureExtractor.actions.AboutAction
	 */
	public AboutAction aboutAction = new AboutAction();

	/**
	 * @see net.sf.jaudio.FeatureExtractor.actions.SaveBatchAction
	 */
	public SaveBatchAction saveBatchAction;

	/**
	 * @see net.sf.jaudio.FeatureExtractor.actions.LoadBatchAction
	 */
	public LoadBatchAction loadBatchAction;

	/**
	 * @see net.sf.jaudio.FeatureExtractor.actions.ExecuteBatchAction
	 */
	public ExecuteBatchAction executeBatchAction;

	/**
	 * @see net.sf.jaudio.FeatureExtractor.actions.AddBatchAction
	 */
	public AddBatchAction addBatchAction;

	/**
	 * @see net.sf.jaudio.FeatureExtractor.actions.RemoveBatchAction
	 */
	public RemoveBatchAction removeBatchAction;

	/**
	 * @see net.sf.jaudio.FeatureExtractor.actions.ViewBatchAction
	 */
	...
	/**
	 * @see net.sf.jaudio.FeatureExtractor.ExtractionThread
	 */
	public ExtractionThread extractionThread;

	/**
	 * @see net.sf.jaudio.FeatureExtractor.BatchExecutionThread
	 */
