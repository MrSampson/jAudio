...
import net.sf.jaudio.FeatureExtractor.FeatureSelectorPanel;
import net.sf.jaudio.FeatureExtractor.RecordingSelectorPanel;
import net.sf.jaudio.FeatureExtractor.RecordingsTableModel;
import net.sf.jaudio.FeatureExtractor.ACE.XMLParsers.FileFilterXML;
...
public class AddRecordingAction extends AbstractAction {
	...
	public void actionPerformed(ActionEvent e) {
		if (load_recording_chooser == null) {
			...
			load_recording_chooser
					.setFileFilter(new net.sf.jaudio.FeatureExtractor.jAudioTools.FileFilterAudio());
			load_recording_chooser
	...
	public void addRecording(File[] toBeAdded) throws Exception {
		...
		Object[] results = net.sf.jaudio.FeatureExtractor.GeneralTools.GeneralMethods
