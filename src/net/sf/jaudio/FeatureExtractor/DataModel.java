...
import net.sf.jaudio.FeatureExtractor.jAudioTools.AudioMethodsPlayback;
...
public class DataModel {
	...
	public void extract(int windowSize, double windowOverlap,
		...
		if((aggregators==null)||(aggregators.length==0)){
			...
			aggregators[0]=new net.sf.jaudio.FeatureExtractor.Aggregators.Mean();
			aggregators[1]=new net.sf.jaudio.FeatureExtractor.Aggregators.StandardDeviation();
			aggregators[2]=new net.sf.jaudio.FeatureExtractor.Aggregators.AreaMoments();
