...
import net.sf.jaudio.FeatureExtractor.GeneralTools.FeatureDisplay;
import net.sf.jaudio.FeatureExtractor.actions.MultipleToggleAction;
...
public class FeatureSelectorPanel extends JPanel implements ActionListener {
	...
	private void extractFeatures() {
		try {
			...
			// is not already.
			if (window_size >= 0) {
				int pow_2_size = net.sf.jaudio.FeatureExtractor.GeneralTools.Statistics
