...
package net.sf.jaudio.FeatureExtractor.GeneralTools;
...
//			return new String("Infinity");
	...
	public static String[] removeDoubles(String[] strings)
	{
		...
		Object[] cleaned_obj = net.sf.jaudio.FeatureExtractor.GeneralTools.GeneralMethods.removeNullEntriesFromArray(editable_strings);
